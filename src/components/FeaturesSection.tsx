...
const FeaturesSection = () => {
  return (
    <section id="features" className="py-24 relative overflow-hidden bg-black/50 backdrop-blur-sm">
      {/* Background elements */}
      <div className="absolute -top-40 right-0 w-96 h-96 bg-brand-blue opacity-10 rounded-full filter blur-3xl"></div>
            ...
            <Card key={index} className="glass-card overflow-hidden rotate-card border border-white/10 bg-brand-dark/30">
              <CardContent className="p-0">
                <div className="p-1">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-gradient-to-r from-brand-purple to-brand-blue">
