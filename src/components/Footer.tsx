        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            ...
            <p className="text-gray-400 text-sm mt-2 max-w-xs">
              Secure your digital assets with institutional-grade multi-signature technology.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-16">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#wallet" className="text-gray-400 hover:text-white text-sm">Wallet</a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="#" className="text-gray-400 hover:text-white text-sm">Compliance</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="mailto:support@vultisig.com" className="text-gray-400 hover:text-white text-sm">support@vultisig.com</a>
                </li>
                <li>
